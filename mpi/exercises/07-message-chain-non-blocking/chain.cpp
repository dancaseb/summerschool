...
int main(int argc, char *argv[]) {
    ...
    MPI_Isend(message.data(), numElements, MPI_INT, destination, sendTag, MPI_COMM_WORLD, &request[0]);
    ...
    MPI_Irecv(receiveBuffer.data(), numElements, MPI_INT, source, rank, MPI_COMM_WORLD, &request[1]);
